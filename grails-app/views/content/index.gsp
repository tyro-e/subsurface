		...
		<div id="list-content" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="absoluteUrl" title="${message(code: 'content.absoluteUrl.label', default: 'Absolute Url')}" />
					
						<th><g:message code="content.event.label" default="Event" /></th>
				...
				<g:each in="${contentInstanceList}" status="i" var="contentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: contentInstance, field: "absoluteUrl")}</td>
					
						<td>${fieldValue(bean: contentInstance, field: "event")}</td>
