...
<html>
    ...
    <body>
        ...
        <div id="show-setlist" class="content scaffold-show" role="main">
            ...
            <f:display bean="setlist" />
            <g:form resource="${this.setlist}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.setlist}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
